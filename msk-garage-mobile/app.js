...
const CONFIG = {
  prices: {
    single: {
      '6': { label: 'от 1 200 000 ₽', copy: 'Для гаража на одни ворота. Финальный расчёт зависит от комплектации, площадки и монтажа.' },
      '8': { label: 'от 1 600 000 ₽', copy: 'Для гаража на одни ворота. Финальный расчёт зависит от комплектации, площадки и монтажа.' },
      '10': { label: 'от 1 900 000 ₽', copy: 'Для гаража на одни ворота. Финальный расчёт зависит от комплектации, площадки и монтажа.' },
    },
    double: {
