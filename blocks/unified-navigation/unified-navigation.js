(function () {
  const root = document.getElementById('unified-navigation-app');
  ...
  try {
    ...
    const stages = [
      {
        ...
        cluster: 'left3',
        children: [
          { label: 'звонок', tooltipCorner: 'bottom-right', tooltipOrbitAngle: 225, tooltipDistance: 10 },
          { label: 'консультация', tooltipCorner: 'top-right', tooltipOrbitAngle: 180, tooltipDistance: 10 },
          { label: 'даты', tooltipCorner: 'top-right', tooltipOrbitAngle: 140, tooltipDistance: 10 }
        ]
      },
      {
        key: 'visit',
        ...
        cluster: 'left3',
        children: [
          { label: 'замер', tooltipCorner: 'bottom-right', tooltipOrbitAngle: 225, tooltipDistance: 10 },
          { label: 'предложения', tooltipCorner: 'top-right', tooltipOrbitAngle: 180, tooltipDistance: 10 },
          { label: 'уточнения', tooltipCorner: 'top-right', tooltipOrbitAngle: 140, tooltipDistance: 10 }
        ]
      },
      {
        key: 'brief',
        ...
        cluster: 'right3',
        children: [
          { label: 'эскиз', tooltipCorner: 'bottom-left', tooltipOrbitAngle: 315, tooltipDistance: 10 },
          { label: 'подтверждение', tooltipCorner: 'bottom-left', tooltipOrbitAngle: 315, tooltipDistance: 10 },
          { label: 'КП', tooltipCorner: 'bottom-left', tooltipOrbitAngle: 320, tooltipDistance: 10 }
        ]
      },
      {
        key: 'design',
        ...
        cluster: 'left3',
        children: [
          { label: 'проект', tooltipCorner: 'bottom-right', tooltipOrbitAngle: 225, tooltipDistance: 10 },
          { label: 'правки', tooltipCorner: 'top-right', tooltipOrbitAngle: 180, tooltipDistance: 10 },
          { label: 'принятие', tooltipCorner: 'top-right', tooltipOrbitAngle: 140, tooltipDistance: 10 }
        ]
      },
      {
        key: 'contract',
        ...
        cluster: 'right3',
        children: [
          { label: 'выезд', tooltipCorner: 'bottom-left', tooltipOrbitAngle: 315, tooltipDistance: 10 },
          { label: 'подписание', tooltipCorner: 'top-left', tooltipOrbitAngle: 0, tooltipDistance: 10 },
          { label: 'цена', tooltipCorner: 'top-left', tooltipOrbitAngle: 40, tooltipDistance: 10 }
        ]
      },
      {
        key: 'build',
        ...
        cluster: 'cross4',
        children: [
          { label: 'стройка', tooltipCorner: 'bottom-left', tooltipOrbitAngle: 300, tooltipDistance: 10 },
          { label: 'контроль', tooltipCorner: 'top-left', tooltipOrbitAngle: 0, tooltipDistance: 10 },
          { label: 'уборка', tooltipCorner: 'top-left', tooltipOrbitAngle: 60, tooltipDistance: 10 },
          { label: 'приёмка', tooltipCorner: 'top-right', tooltipOrbitAngle: 180, tooltipDistance: 10 }
        ]
      },
      {
        key: 'delivery',
        ...
        cluster: 'right3',
        children: [
          { label: 'приёмка', tooltipCorner: 'bottom-left', tooltipOrbitAngle: 315, tooltipDistance: 10 },
          { label: 'документы', tooltipCorner: 'top-left', tooltipOrbitAngle: 0, tooltipDistance: 10 },
          { label: 'оплата', tooltipCorner: 'top-left', tooltipOrbitAngle: 40, tooltipDistance: 10 }
        ]
      }
    ];
    ...
    function createStage(stage) {
      ...
      stage.children.forEach(function (childConfig, index) {
        children.appendChild(createChild(stage, childConfig, index));
      });
    ...
    root.innerHTML = '';
    console.error('[unified-navigation] fatal runtime fail');
  }
})();
